          ...
          <div className="collapse navbar-collapse" id="navbarTogglerDemo02">
            ...
            <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
              ...
              {user?.role === 1 && (
                <>
                  <li className="nav-item">
                    <NavLink className="nav-link text-danger fw-semibold" to="/admin/dashboard">Admin Dashboard</NavLink>
                  </li>
                  <li className="nav-item">
                    <NavLink className="nav-link text-danger fw-semibold" to="/admin/products">Manage Products</NavLink>
                  </li>
                </>
              )}
            </ul>
            ...
            <div className="navbar-icons d-flex align-items-center">
              <NavLink to="/wishlist" className="wishlist-icon me-3">
